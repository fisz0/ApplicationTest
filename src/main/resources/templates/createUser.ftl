...
<#macro createUser isAdminEnabled='false'>
<#-- @ftlvariable name="_csrf" type="org.springframework.security.web.csrf.CsrfToken" -->
<#-- @ftlvariable name="form" type="com.mokon.spring.boot.backend.domain.UserCreateForm" -->
<div class="Absolute-Center is-Responsive col-bg-4 col-md-6 col-sm-1">
    <form role="form" name="form" action="/register/create" method="post">
